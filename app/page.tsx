    ...
    >
      ...
      >
        ...
        {!embedUrl && prop.image_url && (
          <div className="w-full rounded-t-2xl overflow-hidden flex items-center justify-center p-3" style={{ background: 'var(--surface-2)', maxHeight: '70vh' }}>
            <img src={prop.image_url} alt={prop.prop_name} className="max-w-full max-h-[70vh] object-contain" />
          </div>
        )}
...
function PropCard({ prop, index, onClick }: { prop: Prop; index: number; onClick: () => void }) {
  return (
    <article
      ...
      onClick={onClick}
    >
      <div className="h-44 overflow-hidden relative flex items-center justify-center p-2" style={{ background: 'var(--surface-2)' }}>
        {prop.image_url ? (
