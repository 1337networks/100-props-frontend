  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Image */}
        <div className="w-full bg-occ-charcoal overflow-hidden rounded-t-2xl relative flex items-center justify-center p-3" style={{ maxHeight: '70vh' }}>
          {prop.image_url ? (
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {filtered.map((prop, i) => (
              ...
              >
                {/* Image */}
                <div className="h-44 bg-occ-charcoal overflow-hidden relative flex items-center justify-center p-2">
                  {prop.image_url ? (
                    <img
                      src={prop.image_url}
                      alt={prop.prop_name}
